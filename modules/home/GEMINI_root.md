...
- **Safety & Standards:**
  ...
  - **Shell Aliases:** The user has an alias set up for `ssh` (`autossh -M 0`). You must use the `command` prefix when executing standard shell commands to ensure you bypass these aliases (e.g., `command ssh ...`).
